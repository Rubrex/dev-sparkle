        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              <p className="text-base text-gray-700 dark:text-slate-100 md:text-lg">
                The only way you can get best out of this platform is by
                practicing a lot. By a lot we mean stop getting in tutorial
                loops and get on writing code yourself.
              </p>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-200">
                    ...
                    for the World Wide Web. A web developer builds a website
                    from the bottom up, developing everything from layout to
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-200">
                    ...
                    features of a website, and versed in the programming
                    languages required to create them. Web developers will still
                    need to understand the aesthetics and art direction of the
                    site as they implement features.
                    <br></br>
                    <br></br> A web designer will create the logos, graphics,
                    and layout that determine the look and feel of a website.
                    Web designers will use software like Adobe Photoshop and
                    Illustrator to create these materials. A web designer with a
                    knowledge of code can help him/her better communicate with
                    the web developer.
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-200">
                    ...
                    web developer position at a company. You can do the work
                    well, but can you work well with the company?
                  </p>
                </div>
                <div>
                  <p className="mb-4 text-xl font-medium">
                  ...
                  <p className="text-gray-700 dark:text-slate-200">
                    ...
                    Languages and frameworks are updating all the time, and so
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-200">
                    ...
                    any programmer for that matter. But it certainly doesn’t
                    hurt. Universities offer more structure and a smoother
                    learning experience than teaching yourself everything. But
                    costs of attending a university could be a blocker for many.
                  </p>
                </div>
              </div>
            </div>
